...
class NMT(nn.Module):
    ...
    def forward(self, source: List[List[str]], target: List[List[str]]) -> torch.Tensor:
        ...
        self.model_embeddings_source.to(self.device)
        self.model_embeddings_target.to(self.device)
        ...
        # self.model_embeddings_source.forward(source_padded_chars)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        if enc_masks is not None:
            e_t.data.masked_fill_(torch.tensor(enc_masks,dtype=torch.bool), -float('inf'))
